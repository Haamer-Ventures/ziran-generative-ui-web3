...
This project was developed by Kris Haamer (me) based on the experimental [Generative AI demo](https://sdk.vercel.ai/demo) by [Vercel](https://vercel.com) and [Next.js](https://nextjs.org) team members, with contributions from:
